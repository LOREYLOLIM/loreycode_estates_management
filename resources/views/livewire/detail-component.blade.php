          ...
          <div class="col-lg-8">
            <div>
              <div class="slide-one-item home-slider owl-carousel">
                ...
                <div><img src="{{ asset('assets/images/hero_bg_2.jpg') }}" alt="Image" class="img-fluid"></div>
            ...
            <div class="bg-white property-body border-bottom border-left border-right">
              ...
              <div class="row no-gutters mt-5">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="{{ asset('assets/images/img_4.jpg') }}" class="image-popup gal-item"><img src="{{ asset('assets/images/img_4.jpg') }}" alt="Image" class="img-fluid"></a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="{{ asset('assets/images/img_5.jpg') }}" class="image-popup gal-item"><img src="{{ asset('assets/images/img_5.jpg') }}" alt="Image" class="img-fluid"></a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="{{ asset('assets/images/img_6.jpg') }}" class="image-popup gal-item"><img src="{{ asset('assets/images/img_6.jpg') }}" alt="Image" class="img-fluid"></a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="{{ asset('assets/images/img_7.jpg') }}" class="image-popup gal-item"><img src="{{ asset('assets/images/img_7.jpg') }}" alt="Image" class="img-fluid"></a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="{{ asset('assets/images/img_8.jpg') }}" class="image-popup gal-item"><img src="{{ asset('assets/images/img_8.jpg') }}" alt="Image" class="img-fluid"></a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="{{ asset('assets/images/img_1.jpg') }}" class="image-popup gal-item"><img src="{{ asset('assets/images/img_1.jpg') }}" alt="Image" class="img-fluid"></a>
                </div>
